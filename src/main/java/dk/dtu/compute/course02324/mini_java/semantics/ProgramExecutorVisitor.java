...
public class ProgramExecutorVisitor extends ProgramVisitor {
    ...
    private Function<List<Number>,Number> plus1 =
            args -> args.get(0);


        // Minus:
            //  Minus2int has been added:
    ...
    public void visit(WhileLoop whileLoop) {
        /* TODO Assignment 5b: Here some code which actually executes the
                while loop must be added.
                -
                This code should get the current value
                of the expression, and if that expression is greater or equal
                than 0, execute the statement of the loop (by recursively
                executing the statement by invoking the accept method).
                -
                After that, it should trigger the evaluation of the expression of the
        ...
        whileLoop.expression.accept(this); // evaluates the while loop's condition expression.
