...
public class ProgramTypeVisitor extends ProgramVisitor {
    ...
    final private Map<Operator,List<Type>> operatorTypes = Map.ofEntries(
            ...
            // What has been added (also Binary Operators):
    ...
    public void visit(WhileLoop whileLoop) {
        ...
        // Check that the expression is of type integer:
            Type expressionType = typeMapping.get(whileLoop.expression);
                if (expressionType == null) {
                    problems.add("The condition expression of the while loop does not have a type.");
                } else if (!expressionType.equals(INT)) {
                    problems.add("The condition expression of the while loop must be of type integer, but is of type " + expressionType.getName() + ".");
                }
